...
const api = new LeagueJs('RGAPI-0f4a3a90-68fa-482b-850f-62dc311c0912');
                            ...
                            .then(champ => {
                                ...
                                for (var i = 0 ; i < spect.participants.length ; i++)
                                {
                                    if (spect.participants[i].teamId == 100)
                                    {
                                        ...
                                        if (spect.bannedChampions && spect.bannedChampions[i].championId > 0)
                                            blueTeamData.bans += `${champ.data[spect.bannedChampions[i].championId].name} \n`;
                                    }
                                    if (spect.participants[i].teamId == 200)
                                    {
                                        ...
                                        if (spect.bannedChampions && spect.bannedChampions[i].championId > 0)
                                            redTeamData.bans += `${champ.data[spect.bannedChampions[i].championId].name} \n`;
                                    }
                                }
                                ...
                                var embed = new Discord.RichEmbed()
                                    ...
                                    .addBlankField()
                                    .addField("Blue team bans", blueTeamData.bans == '' ? 'No champions banned' : blueTeamData.bans, true)
                                    .addField("Red team bans", redTeamData.bans == '' ? 'No champions banned' : redTeamData.bans, true)
                                    .setColor(0x00FFFF)
