...
<+>UTF-8
===================================================================
--- package-lock.json	(date 1504106301000)
...
<+>UTF-8
===================================================================
--- package.json	(date 1504106301000)
...
<+>UTF-8
===================================================================
--- lib/LeagueJS.js	(date 1504106301000)
+++ lib/LeagueJS.js	(revision )
@@ -1,11 +1,10 @@
 'use strict';
...
<+>UTF-8
===================================================================
--- test/util/ErrorUtil.test.js	(date 1504106301000)
+++ test/util/ErrorUtil.test.js	(revision )
@@ -3,7 +3,7 @@
...
<+>UTF-8
===================================================================
--- lib/Config.js	(date 1504106301000)
+++ lib/Config.js	(revision )
@@ -42,10 +42,12 @@
 		}
 	},
 	'limits': {
...
<+>UTF-8
===================================================================
--- lib/endpoints/LolStatusEndpoint.js	(date 1504106301000)
+++ lib/endpoints/LolStatusEndpoint.js	(revision )
@@ -5,8 +5,8 @@
  */
 class LolStatusEndpoint extends Endpoint {
...
<+>UTF-8
===================================================================
--- lib/util/ErrorUtil.js	(date 1504106301000)
+++ lib/util/ErrorUtil.js	(revision )
@@ -1,9 +1,8 @@
 const ParameterError = require('../errors/ParameterError');
 const SummonerUtil = require('./SummonerUtil');
-const RateLimiter = require('../ratelimiter/RateLimiter');
...
<+>UTF-8
===================================================================
--- test/TestUtil.js	(date 1504106301000)
+++ test/TestUtil.js	(revision )
@@ -1,6 +1,7 @@
 const deepmerge = require('deepmerge');
 const Config = require('../lib/Config');
-const LeagueJSRateLimiter = require('../lib/ratelimiter/LeagueJSRateLimiter');
...
<+>UTF-8
===================================================================
--- lib/Endpoint.js	(date 1504106301000)
...
<+>UTF-8
===================================================================
--- lib/ApiRequest.js	(date 1504106301000)
+++ lib/ApiRequest.js	(revision )
@@ -1,6 +1,4 @@
 const requestP = require('request-promise');
-// const rate = require('./rateInfo');
-
...
Index: lib/ratelimiter/rateInfo.js
===================================================================
--- lib/ratelimiter/rateInfo.js	(date 1504106301000)
+++ lib/ratelimiter/rateInfo.js	(date 1504106301000)
@@ -1,76 +0,0 @@
-/**
...
<+>UTF-8
===================================================================
--- test/endpoints/StaticDataEndpoint.test.js	(date 1504106301000)
+++ test/endpoints/StaticDataEndpoint.test.js	(revision )
@@ -21,8 +21,9 @@
 	const mock_summonerSpell = TestUtil.mocks.summonerSpells.Flash;
